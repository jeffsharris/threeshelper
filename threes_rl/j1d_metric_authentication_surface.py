"""Training-only J1d metric-authentication surface and readiness sealer.
...
VERSION = "j1d_metric_authentication_surface_v1"
REPO_ROOT = Path(__file__).resolve().parents[1]
RUNS_ROOT = REPO_ROOT / "threes_rl" / "runs"
CHARTER_PATH = (
    REPO_ROOT
    / "threes_rl"
    / "J1D_METRIC_AUTHENTICATION_REPAIR_CHARTER.md"
)
RUNNER_PATH = (
    REPO_ROOT / "threes_rl" / "j1d_metric_authentication_surface.py"
)
TEST_PATH = (
    REPO_ROOT / "tests" / "test_rl_j1d_metric_authentication_surface.py"
)
READINESS_DIR = (
    RUNS_ROOT
    / "forensics"
...
EXPECTED_CANONICAL_ROWS_SHA256 = (
    "3507a5851f5c2b395e86196ed03fea158153158eca7e837861ed015d18ac36c7"
)
EXPECTED_ROOT_COMMITMENT_PAYLOAD_SHA256 = (
    "886cd9e2ba6b459e4a6a540c6878326313877ae0c8039902ffc8d8af82cfdab2"
)
EXPECTED_ROOT_SET_SHA256 = (
    "1026ed0dabc8cc7d3327c952efb394b4a6b9656039096c824461a3815959871b"
)
...
TEST_EVIDENCE_NAME = "J1D_METRIC_AUTHENTICATION_TEST_EVIDENCE.json"
SOURCE_MANIFEST_NAME = "J1D_PROSPECTIVE_TRAINING_MANIFEST.json"
STREAM_AUTHORITY_NAME = "J1D_PROTECTED_STREAM_AUTHORITY.json"
ROOT_CAUSE_NAME = "J1D_METRIC_AUTHENTICATION_ROOT_CAUSE.json"
SCHEMA_NAME = "J1D_METRIC_AUTHENTICATION_SCHEMA.json"
PROJECTION_NAME = "J1D_METRIC_AUTHENTICATION_PROJECTION.json"
INPUT_BINDINGS_NAME = "J1D_METRIC_AUTHENTICATION_INPUT_BINDINGS.json"
READINESS_LOCK_NAME = "J1D_METRIC_AUTHENTICATION_READINESS_LOCK.json"
READINESS_RESULT_NAME = "J1D_METRIC_AUTHENTICATION_READINESS_RESULT.json"
READY_DECISION = "READY_J1D_METRIC_AUTHENTICATION_PREFLIGHT"
HOLD_DECISION = "HOLD_J1D_METRIC_AUTHENTICATION_PREFLIGHT"
KILL_DECISION = "KILL_J1D_METRIC_AUTHENTICATION_PREFLIGHT_INTEGRITY"
...
CANONICAL_METRIC_ALGORITHM = (
    "manifest_order_numpy_float64_mean_of_authenticated_per_root_rows_v1"
)
...
def canonicalize_round_metric_row(
    ...
    authentication = payload_with_hash(
        {
            "version": f"{VERSION}_round_metric_authentication_v1",
